...
// seedExercises adds sample exercise data with at least 5 exercises per category
func (r *InMemoryExerciseRepository) seedExercises() {
	...
	exercises := []domain.Exercise{
		...
		{
			ID:                "me-004",
			Name:              "Tongue Blade Workout",
			Description:       "Strengthen tongue blade for advanced sounds",
			Category:          domain.CategoryMouthExercise,
			Difficulty:        domain.DifficultyIntermediate,
			ArticulationPoints: []domain.ArticulationPoint{domain.ArticulationTongueBlade, domain.ArticulationTongueBack},
			Duration:          90 * time.Second,
			Repetitions:       12,
			Instructions:      "Press tongue blade against roof of mouth, hold, then release. Vary pressure.",
			PhoneticGuidance:  "Focus on the middle of your tongue",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		{
			ID:                "me-005",
			Name:              "Soft Palate Lift",
			Description:       "Exercise the soft palate for better resonance",
			Category:          domain.CategoryMouthExercise,
			Difficulty:        domain.DifficultyAdvanced,
			ArticulationPoints: []domain.ArticulationPoint{domain.ArticulationSoftPalate},
			Duration:          120 * time.Second,
			Repetitions:       8,
			Instructions:      "Yawn to feel the soft palate lift. Say 'ah' with raised soft palate. Hold and release.",
			PhoneticGuidance:  "Imagine the sound coming from the back of your throat",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		...
		{
			ID:                "tt-005",
			Name:              "Unique New York",
			Description:       "Tongue twister for Y and OO sounds",
			Category:          domain.CategoryTongueTwister,
			Difficulty:        domain.DifficultyBeginner,
			TargetSounds:      []domain.SoundTarget{domain.SoundJ},
			Duration:          30 * time.Second,
			Repetitions:       5,
			Instructions:      "Say 'Unique New York, unique New York, you know you need unique New York' clearly.",
			PhoneticGuidance:  "Focus on the Y sound at the start of unique",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		// Diction strategies (5+)
		{
			ID:                "ds-001",
		...
		{
			ID:                "ds-003",
			Name:              "Precision Enunciation",
			Description:       "Practice precise mouth positions for each sound",
			Category:          domain.CategoryDictionStrategy,
			Difficulty:        domain.DifficultyAdvanced,
			Duration:          150 * time.Second,
			Repetitions:       3,
			Instructions:      "Select 10 words and say each one slowly, exaggerating each sound. Record and playback.",
			PhoneticGuidance:  "Each sound has a specific mouth position - find it",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		{
			ID:                "ds-004",
			Name:              "Resonance Building",
			Description:       "Develop proper resonance for richer voice",
			Category:          domain.CategoryDictionStrategy,
			Difficulty:        domain.DifficultyIntermediate,
			Duration:          100 * time.Second,
			Repetitions:       4,
			Instructions:      "Hum at different pitches, feeling vibration in your face. Then apply to speech.",
			PhoneticGuidance:  "Feel the vibration in your nasal cavity and face",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		{
			...
			Description:       "Learn to control breath for sustained speech",
			Category:          domain.CategoryDictionStrategy,
			Difficulty:        domain.DifficultyBeginner,
			Duration:          80 * time.Second,
			Repetitions:       5,
			Instructions:      "Take a deep breath and try to speak on one breath for as long as possible. Count how many words you can say.",
			PhoneticGuidance:  "Breathe from diaphragm, not chest",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		...
		{
			ID:                "ps-002",
			Name:              "Syllable Timing",
			Description:       "Practice even syllable timing for clearer speech",
			Category:          domain.CategoryPacingStrategy,
			Difficulty:        domain.DifficultyIntermediate,
			Duration:          100 * time.Second,
			Repetitions:       4,
			Instructions:      "Say a sentence with equal emphasis on each syllable. Then compare to natural speech.",
			PhoneticGuidance:  "Metronome can help - set to 60 BPM and speak one syllable per beat",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		{
			...
			Description:       "Learn to group words into meaningful phrases",
			Category:          domain.CategoryPacingStrategy,
			Difficulty:        domain.DifficultyIntermediate,
			Duration:          90 * time.Second,
			Repetitions:       5,
			Instructions:      "Mark phrases in a text with slashes. Read each phrase as a single unit.",
			PhoneticGuidance:  "Phrases are thought units - complete one before moving on",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		{
			ID:                "ps-004",
			Name:              "Emphasis Patterns",
			Description:       "Practice placing emphasis on key words",
			Category:          domain.CategoryPacingStrategy,
			Difficulty:        domain.DifficultyAdvanced,
			Duration:          120 * time.Second,
			Repetitions:       4,
			Instructions:      "Say the same sentence with emphasis on different words. Notice how meaning changes.",
			PhoneticGuidance:  "Emphasized words are usually content words (nouns, verbs, adjectives)",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
		{
			...
			Description:       "Practice at slow speed to build muscle memory",
			Category:          domain.CategoryPacingStrategy,
			Difficulty:        domain.DifficultyBeginner,
			Duration:          120 * time.Second,
			Repetitions:       3,
			Instructions:      "Choose a paragraph and read it at half your normal speed. Focus on each sound.",
			PhoneticGuidance:  "Slow down until you can say every sound clearly",
			CompletionCount:   0,
			CreatedAt:         now,
			UpdatedAt:         now,
		},
